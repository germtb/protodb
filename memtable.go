...
func (m *memtable) Put(key Key, value []byte, seqnum uint64) {
	m.list.Put(key, value, seqnum)
}

func (m *memtable) Delete(key Key, seqnum uint64) {
...
func (m *memtable) Get(key Key, snapshotSeq uint64) ([]byte, error) {
...
func (m *memtable) Scan(lo, hi Key, snapshotSeq uint64) *skiplistIterator {
